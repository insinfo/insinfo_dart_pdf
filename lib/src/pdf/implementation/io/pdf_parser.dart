...
class PdfParser {
  ...
  /// internal property
  PdfTokenType? get next => _next;

  /// internal property
  PdfLexer? get lexer => _lexer;
  ...
  /// Read fdf object
  FdfObject? parseObject() {
    final IPdfPrimitive? num1 = simple();
    final IPdfPrimitive? num2 = simple();
    ...
    return num1 != null &&
            ...
            num1 is PdfNumber &&
            num2 is PdfNumber
        ? FdfObject(num1, num2, obj)
        : null;
  }

  /// internal method
  IPdfPrimitive trailer() {
